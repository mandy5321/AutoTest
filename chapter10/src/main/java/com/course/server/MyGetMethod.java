...
/**
 * Created by zhangjie on 2020/6/15.GET
 */
@RestController
...
public class MyGetMethod {
    ...
    public String getCookies(HttpServletResponse response){
        //HttpseverletRequest
        //HttpSeverletReaponse
        Cookie cookie =new Cookie("login","true");
        response.addCookie(cookie);
        return "恭喜获得cookie信息";
    }
    @RequestMapping(value = "/getWithCookies",method = RequestMethod.GET)
    @ApiOperation(value = "通过这个方法可以携带cookies",httpMethod = "GET")
...
/*    @RequestMapping(name = "/getlist",method = RequestMethod.GET)
    ...
    * url:ip:port
    */
    @RequestMapping(value = "/getwithCookiesparam/{start}/{end}")
